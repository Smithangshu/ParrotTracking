...
void CHeli::setAngles(float ipitch, float iroll, float iyaw, float iheight, int hover)
{
    ...
    at_set_radiogp_input(roll, pitch, height, yaw, hover);
}	

void CHeli::getHeliData(double &phi, double &psi, double &theta, double &altitude, double &battery, double &vx, double &vy, double &vz)
{
    updateHeliData(phi, psi, theta, altitude, battery, vx, vy, vz);
}
