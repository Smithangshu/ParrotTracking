...
void Parrot::setAngles(float roll, float pitch, float yaw, float verticalSpeed)
{
    //heli->setAngles(300.0 * roll, 300.0 * pitch, 300.0 * yaw, 300.0 * verticalSpeed);
    heli->setAngles(-300.0 * pitch, 300.0 * roll, 300.0 * yaw, -300.0 * verticalSpeed);
    //heli->setAngles(2 * roll, 2 * pitch, 2 * yaw, 2 * verticalSpeed);
}
#endif
